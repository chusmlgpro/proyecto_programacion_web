        ...
        <header>
            <nav class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul>
                    ...
                    <li class="col-lg-2 col-md-2 col-sm-2 col-xs-12"><a  href="../Personal/index.php">PERSONAL <i class="fa fa-address-book"></i></a></li>
                    </li>
                    <li class="col-lg-2 col-md-2 col-sm-2 col-xs-12"><a id="Inicio" href="../Departamentos/index.php">DEPARTAMENTOS <i class="fa fa-tty"></i></a></li>
                    </li>
